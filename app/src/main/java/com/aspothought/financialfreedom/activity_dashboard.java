...
public class activity_dashboard extends ActionBarActivity
        implements NavigationDrawerManager.NavigationDrawerCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavigationDrawerManager = (NavigationDrawerManager) getSupportFragmentManager().findFragmentById(R.id.navigation_drawer);
        mTitle = getTitle();

        // Set up the drawer.
        mNavigationDrawerManager.setUp(R.id.navigation_drawer, (DrawerLayout) findViewById(R.id.drawer_layout));
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!mNavigationDrawerManager.isDrawerOpen()) {
    ...
    public static class DashboardFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_activity_dashboard, container, false);
            return rootView;
        }
